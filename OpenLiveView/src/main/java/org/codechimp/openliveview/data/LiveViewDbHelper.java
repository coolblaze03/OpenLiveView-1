package org.codechimp.openliveview.data;
...
public class LiveViewDbHelper {
    ...
    private static final String SCRIPT_CREATE_ALERT_ITEMS_TRIGGER =
            "create trigger alert_items_insert_trigger"
                    + " AFTER INSERT"
                    + " ON "
                    + LiveViewDbConstants.TABLE_ALERT_ITEMS
                    + " BEGIN"
                    + " DELETE FROM "
                    + LiveViewDbConstants.TABLE_ALERT_ITEMS
                    + " WHERE " + LiveViewDbConstants.COLUMN_ALERT_ITEMS_ID + " NOT IN (SELECT " + LiveViewDbConstants.COLUMN_ALERT_ITEMS_ID + " FROM "
                    + LiveViewDbConstants.TABLE_ALERT_ITEMS
                    + " ORDER BY " + LiveViewDbConstants.COLUMN_ALERT_ITEMS_TIMESTAMP + " DESC LIMIT 50);"
                    + " END;)";
    ...
    public String getAllAlertsAsString() {
    ...
    public Cursor getAllAlerts(String[] columns) {
        Cursor cursor = sqLiteDatabase.query(LiveViewDbConstants.TABLE_ALERT_ITEMS, columns, null, null, null, null, null);
    ...
    public class SQLiteHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL(SCRIPT_CREATE_ALERT_ITEMS_TRIGGER);
        }
