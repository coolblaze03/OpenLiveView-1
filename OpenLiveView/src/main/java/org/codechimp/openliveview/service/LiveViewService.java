...
public class LiveViewService extends Service {
    ...
    final public static String PLUGIN_COMMAND = "org.codechimp.openliveview.plugin.command";
    ...
    private BroadcastReceiver media_receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d("openliveview Music", "Artist: " + MediaInfoArtist + ", Album: " + MediaInfoAlbum + " and Track: " + MediaInfoTrack);
        }
    };
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            try {
                if (incomingNumber.length() > 0)
                    Log.d("PhoneCallStateNotified", "Incoming number " + incomingNumber);
